...
export const mockFeeds: Feed[] = [
  ...
  },
  {
    ...
    scraping_config: {
      ...
      author_selector: '.crayons-story__secondary .profile-preview-card__trigger',
    ...
    sample_articles: [
      {
        ...
        preview: 'In this comprehensive guide, we explore the landscape of modern JavaScript frameworks...'
      },
      {
        title: 'The Future of Web Development',
        url: 'https://example-blog.com/future-web-dev',
        preview: 'As we look ahead to the next decade, several trends are shaping the future...'
      }
    ]
  }
};
    ...
    articles: [
      {
        ...
        content: '<p>React continues to evolve, and with it, new patterns emerge...</p>',
      ...
      },
      {
        ...
        content: '<p>When building large-scale applications with Node.js...</p>',
