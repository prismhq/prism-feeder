...
export const mockEntries: Entry[] = [
  {
    ...
    summary:
      "Researchers announce NextGen-LLM, a new language model achieving human-level performance with 99.2% accuracy on complex reasoning tasks.",
  ...
  },
  {
    ...
    feed_id: "feed-2",
    title:
      "Quantum Computing Makes Major Leap with New Error Correction Method",
    ...
    summary:
      "IBM develops Adaptive Quantum Error Correction technique, reducing quantum computing error rates by up to 1000x.",
    author: "David Chen",
  ...
  },
  {
    ...
    summary:
      "OpenAI announces GPT-5 with multimodal capabilities, advanced reasoning, and improved safety features.",
    author: "OpenAI Team",
  ...
  },
  {
    ...
    summary:
      "Comprehensive guide exploring the Transformer architecture, self-attention mechanisms, and their revolutionary impact on ML.",
...
@container card (min-width: 400px) {
  .card {
    ...
    summary:
      "Explore CSS container queries and how they enable truly modular responsive design patterns.",
    author: "Chris Coyier",
...
async function UserProfile({ userId }) {
  ...
  return <div>{user.name}</div>;
    ...
    summary:
      "Practical guide to React Server Components, covering benefits, implementation patterns, and best practices.",
    author: "Maria Garcia",
  ...
  },
  {
    ...
    summary:
      "How Shopify built and scaled their Polaris design system across 10,000+ employees and hundreds of product teams.",
    author: "Jennifer Lee",
  ...
  // More entries for pagination testing
  {
    ...
    content:
      "<div><p>An in-depth analysis of the Web3 gaming market, examining real adoption metrics versus hype...</p></div>",
    summary:
      "Critical analysis of Web3 gaming market trends, adoption metrics, and future prospects.",
    author: "Mike Torres",
  ...
  },
  {
    ...
    content:
      "<div><p>New data from the Europa Clipper mission reveals extensive water ice deposits beneath the moon's surface...</p></div>",
    summary:
      "Europa Clipper mission discovers extensive water ice deposits, raising possibilities for extraterrestrial life.",
  ...
  },
  {
    ...
    content:
      "<div><p>A comprehensive comparison of CSS Grid and Flexbox, when to use each, and how they complement each other...</p></div>",
    summary:
      "Updated guide comparing CSS Grid and Flexbox, with practical examples for modern layout challenges.",
...
// Mock unread entries
export const mockUnreadEntries = mockEntries.filter(
  (entry) => entry.status === "unread"
);

// Mock starred entries
export const mockStarredEntries = mockEntries.filter(
  (entry) => entry.status === "starred"
);
